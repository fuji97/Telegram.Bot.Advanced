...
/// </summary>
public sealed class ChatRoleFilter : DispatcherFilterAttribute {
    ...
    /// <inheritdoc />
    public override bool IsValid(Update update, TelegramChat? user, MessageCommand command, ITelegramBotData botData) => user != null && _role.Contains(user.Role);
}
